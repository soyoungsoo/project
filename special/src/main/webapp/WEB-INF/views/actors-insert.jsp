...
<script type="text/javascript">
    function add() {
        $('#fileview').append(
            '<tr><th class="text-right">- 이름</th>'+
            '<td class="actors-input"><input class="detail-video" type="text" name="name" id="video-input"></td>'+
            '</tr><tr><th class="text-right">- 직업</th>'+
            '<td class="actors-input"><input class="detail-video" type="text" name="job" id="video-input"></td>'+
            '</tr><tr><th class="text-right">- 사진</th>'+
            '<td class="actors-input"><input class="insert-file detail-images" type="file" name="photo"></td>'+'</tr>');
    }
        ...
        <div class="container">
            ...
            <div class="content">
                <form method="post" action="/special/movie/insert_actors" enctype="multipart/form-data" id="joinForm">
                    <table id="fileview" class="table-join">
                        <tr>
                        ...
                        <tr>
                            <th class="text-right">- 직업</th>
                            <td class="actors-input"><input class="detail-video" type="text" name="job" id="video-input"></td>
                        </tr>
                        <tr>
                            <th class="text-right">- 사진</th>
                            <td class="actors-input"><input class="insert-file detail-images" type="file" name="photo"></td>
                        </tr>
                        <tr>
