...
<link rel="stylesheet" type="text/css"
	href="<c:url value='/resources/jQuery-Radiobtn/css/zInput_default_stylesheet.css'/>">
<link rel="stylesheet" type="text/css"
	href="<c:url value='/resources/css/main.css'/>">
<link rel="stylesheet" type="text/css"
	href="<c:url value='/resources/css/seat.css'/>">
<link rel="stylesheet" type="text/css"
								...
								.each(
										...
										function(key, value) {
											var eachrow = '<ul class="ajax-button'+ key +'" id="'+ value.rdate +'">'
													...
													+ '</li>'
													+ '</ul>'
													+ '<input type="button" id="ajax-button'+ key +'" value="좌석보기">';
											...
											$(
													...
													.click(
															function(e) {
																...
																// 								 $('.seat_Barea').append(str);
																var dd = document
																		.getElementById("Barea");
																if (dd
																		.hasChildNodes()) {
																	while (dd
																			.hasChildNodes()) {
																		dd
																				.removeChild(dd.firstChild);
																	}
																}
																						...
																						.each(
																								...
																								function(
																									...
																									'<a class="p0 '
																											...
																											+ value.seatno
																											+ ' - 일반석"'
																											+ 'seat-code="1A01" onclick="selectedSeat(this);">'
																											+ (key + 1)
																											+ '</a>'
			...
			<div class="content ">
				<form action="/special/movie/ticket" method="post" id="reserv-form">
					...
					<div id="request">
						...
						<a href="javascript:{}" onclick="submitTest();" class="reg-btn">예매
							하기</a> <input type="hidden" name="${_csrf.parameterName}"
							value="${_csrf.token}">
					</div>
				</form>
